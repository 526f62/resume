...
\begin{cventries}
	...
	{\begin{cvitems}
		...
		\item {.Net/ .Net core/ ASP.Net Backend development with Azure}
		\item {Cloud operations + deployment}
		\end{cvitems}}
	\cventry
	{Software Developer}
	{Katanya}
	...
	{Apr 2020 – Aug 2020}
	{\begin{cvitems}
		\item {Web tooling development}
			\subitem {Javascript Bookmarklets}
			\subitem {HTML5}
			\subitem {CSS}
			\subitem {React}
			\subitem {Gatsby}
		\item {Web content authoring}
			\subitem {Adobe AEM}
			\subitem {UAT}
		\end{cvitems}}
\end{cventries}
...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		Programming:  & {\skill{ Java, C, C++, C\#, Python, Powershell, Javascript, Typescript, HTML, CSS}} \\
...
\begin{cventries}
	...
	{}
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		Programming:  & {\skill{ Game development, Gamification, Embedded development}} \\
		Linux / Unix:  & {\skill{ Ricing, Automation}} \\
		Malware analysis:  & {\skill{ Static/Dynamic analysis of 32bit malware}} \\
		Information / Cyber Security: & {\skill{ Network/Application security, Industrial/Operational security, SCADA, PLC, DCS, SIS}} \\
		\end{tabular}}}
	{}
	{}
	{}
...
\begin{cventries}
	...
	{}
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		Security:  & {\skill{ IoT Security, Physical Security, Network Security, Malware analysis}} \\
		Programming:  & {\skill{Automation, Game Development/ Gamification}} \\
		Hardware:  & {\skill{NFC, Mechanical keyboards, Raspberry Pi}} \\
		\end{tabular}}}
	{}
	{}
	{}
